module.exports = {
    // paths: ['abas/apps/core/frontend/utils/'],
    moduleApiChange: true,
    transform: function({ file, root, api, options }) {
        ...
        const didTransform = replacedBoundFunctions || replacedCallbacks;
